...
public class AtomUtil
{
    ...
    {
        if (protonAmount < 0 || protonAmount > atomNames.Length - 1) return "";
        return atomNames[protonAmount];
    }

    public static string getAtomSymbol(int protonAmount)
    {
        if (protonAmount < 0 || protonAmount > atomSymbols.Length - 1) return "";
        return atomSymbols[protonAmount];
    }
